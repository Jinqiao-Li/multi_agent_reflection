...
2. Evaluate the Student’s Work  
- Assign a score (0 or 1) to your dimension:
  - 1 = The dimension is clearly present and meaningfully developed.
  - 0 = The dimension is missing, weak, or inadequately addressed.
- Write a judgement that includes:
  - Strengths – What the student did well within your dimension.
  - Weaknesses – What is lacking, vague, or unclear.
  - Suggestions – Specific, constructive advice to help the student improve.
...
{{
  ...
  "score": 0 or 1,
  "judgement": "Your full written feedback here."
}}
...
**Standard Example 1**
   ...
   "grades": {{ "Experience": 1, "Analysis": 0, "Action": 1}}}}
...
**Standard Example 2**
  ...
  "grades": {{ "Experience": 1, "Analysis": 1, "Action": 0}} }}


Reminder:
You are responsible for only one dimension of the reflection. Do not evaluate or mention other parts of the response.
"""
